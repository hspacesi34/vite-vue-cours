    ...
    <div class="container mx-auto p-4 md:p-8">
        ...
        <div class="card bg-base-100 shadow-xl mb-6">
            <div class="card-body">
                ...
                <p>
                    La directive `v-html` est utilisée pour insérer du HTML brut dans un élément du DOM. Contrairement aux moustaches, qui affichent le texte tel quel, `v-html` interprète le HTML.
                </p>
